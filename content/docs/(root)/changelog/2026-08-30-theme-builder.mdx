...
- **Theme Picker** — Browse and switch between 9 built-in presets (Professional, Modern, Minimal, Executive, Corporate, Elegant, Vivid, Forest, Blueprint)
...
- **Shareable URLs** — Theme state is encoded in the URL hash so you can share a exact configuration with anyone
...
Navigate to the Theme Builder from the site header, or go directly to `/theme-builder/takumi`. Pick a preset, tweak the settings, and copy the code when you're happy.
