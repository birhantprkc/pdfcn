---
title: Theming
description: Configure PDF themes, colors, typography, and spacing for Takumi.
---
...
```bash
npx shadcn@latest add @pdfcn/theme-provider
```
...
```tsx
import { PdfcnThemeProvider } from "@/registry/bases/takumi/components";
